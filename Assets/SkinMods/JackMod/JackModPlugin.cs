...
namespace JackMod
{
    ...
    [BepInPlugin("com.JackTYM.JackMod","JackMod","1.0.0")]
    public partial class JackModPlugin : BaseUnityPlugin
    {
        internal static JackModPlugin Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("JackMod.jacktymjackmod"))
            {
        ...
        private static void LanguageLoadStrings(Action<Language> orig, Language self)
        {
            ...
            self.SetStringByToken("JACKTYM_SKIN_JACKSKIN_NAME", "JackMod");
        }
        ...
        private static void AddHuntressBodyJackSkinSkin()
        {
            ...
            try
            {
                ...
                TryCatchThrow("Icon", () =>
                {
                    skin.icon = assetBundle.LoadAsset<Sprite>(@"Assets\SkinMods\JackMod\Icons\JackSkinIcon.png");
                });
                skin.name = skinName;
                ...
                TryCatchThrow("Mesh Replacements", () =>
                {
                    skin.meshReplacements = new SkinDef.MeshReplacement[]
                    {
                        ...
                        {
                            mesh = assetBundle.LoadAsset<Mesh>(@"Assets\SkinMods\JackMod\Meshes\char.001.mesh"),
                            renderer = renderers.First(r => r.name == "HuntressMesh")
                        },
                    };
                });
