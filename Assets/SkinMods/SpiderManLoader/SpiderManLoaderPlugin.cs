...
namespace SpiderManLoader
{
    
    [BepInPlugin("com.JackTYM.SpiderManLoader","SpiderManLoader","1.0.0")]
    public partial class SpiderManLoaderPlugin : BaseUnityPlugin
    {
        internal static SpiderManLoaderPlugin Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SpiderManLoader.jacktymspidermanloader"))
            {
        ...
        private static void LanguageLoadStrings(Action<Language> orig, Language self)
        {
            ...
            self.SetStringByToken("JACKTYM_SKIN_SPIDERMANLOADER_NAME", "Spider-Man");
        }
        ...
        private static void BodyCatalogInit()
        {
            ...
            AddLoaderBodySpidermanLoaderSkin();
        ...
        static partial void LoaderBodySpidermanLoaderSkinAdded(SkinDef skinDef, GameObject bodyPrefab);

        private static void AddLoaderBodySpidermanLoaderSkin()
        {
            var bodyName = "LoaderBody";
            var skinName = "SpidermanLoader";
            try
            {
                ...
                TryCatchThrow("Icon", () =>
                {
                    skin.icon = assetBundle.LoadAsset<Sprite>(@"Assets\SkinMods\SpiderManLoader\Icons\SpidermanLoaderIcon.png");
                });
                skin.name = skinName;
                skin.nameToken = "JACKTYM_SKIN_SPIDERMANLOADER_NAME";
                skin.rootObject = mdl;
                ...
                TryCatchThrow("Renderer Infos", () =>
                {
                    skin.rendererInfos = new CharacterModel.RendererInfo[]
                    {
                        ...
                        {
                            defaultMaterial = assetBundle.LoadAsset<Material>(@"Assets/Spiderman.mat"),
                ...
                TryCatchThrow("Mesh Replacements", () =>
                {
                    skin.meshReplacements = new SkinDef.MeshReplacement[]
                    {
                        ...
                        {
                            mesh = assetBundle.LoadAsset<Mesh>(@"Assets\SkinMods\SpiderManLoader\Meshes\spiderman.mesh"),
                            renderer = renderers[2]
                        },
                    };
                });
                ...
                LoaderBodySpidermanLoaderSkinAdded(skin, bodyPrefab);
            }
